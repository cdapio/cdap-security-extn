...
public class CDAPRangerLookupClientTest {
  ...
  public void testPrograms() throws Exception {
    ...
    ApplicationDetail applicationDetail = new ApplicationDetail("name", ApplicationId.DEFAULT_VERSION, "desc", null, "config", null,
                                                                programRecords, null, new ArtifactSummary("art", "1"), null);
