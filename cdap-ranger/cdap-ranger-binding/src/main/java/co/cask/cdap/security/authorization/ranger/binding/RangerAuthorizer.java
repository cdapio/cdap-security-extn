...
public class RangerAuthorizer extends AbstractAuthorizer {
  ...
  private void setAccessResource(EntityId entityId, RangerAccessResourceImpl rangerAccessResource) {
    ...
    switch (entityType) {
      case INSTANCE:
        rangerAccessResource.setValue(RangerCommons.KEY_INSTANCE, ((InstanceId) entityId).getInstance());
        break;
      case NAMESPACE:
        setAccessResource(new InstanceId(instanceName), rangerAccessResource);
        rangerAccessResource.setValue(RangerCommons.KEY_NAMESPACE, ((NamespaceId) entityId).getNamespace());
        break;
      case ARTIFACT:
        ArtifactId artifactId = (ArtifactId) entityId;
        setAccessResource(artifactId.getParent(), rangerAccessResource);
        rangerAccessResource.setValue(RangerCommons.KEY_ARTIFACT, artifactId.getArtifact() +
          RangerCommons.RESOURCE_SEPARATOR + artifactId.getVersion());
        break;
      case APPLICATION:
        ApplicationId applicationId = (ApplicationId) entityId;
        setAccessResource(applicationId.getParent(), rangerAccessResource);
        rangerAccessResource.setValue(RangerCommons.KEY_APPLICATION, applicationId.getApplication());
        break;
      case DATASET:
        DatasetId dataset = (DatasetId) entityId;
        setAccessResource(dataset.getParent(), rangerAccessResource);
        rangerAccessResource.setValue(RangerCommons.KEY_DATASET, dataset.getDataset());
        break;
      case DATASET_MODULE:
        DatasetModuleId datasetModuleId = (DatasetModuleId) entityId;
        setAccessResource(datasetModuleId.getParent(), rangerAccessResource);
        rangerAccessResource.setValue(RangerCommons.KEY_DATASET_MODULE, datasetModuleId.getModule());
        break;
      case DATASET_TYPE:
        DatasetTypeId datasetTypeId = (DatasetTypeId) entityId;
        setAccessResource(datasetTypeId.getParent(), rangerAccessResource);
        rangerAccessResource.setValue(RangerCommons.KEY_DATASET_TYPE, datasetTypeId.getType());
        break;
      case STREAM:
        StreamId streamId = (StreamId) entityId;
        setAccessResource(streamId.getParent(), rangerAccessResource);
        rangerAccessResource.setValue(RangerCommons.KEY_STREAM, streamId.getStream());
        break;
      case PROGRAM:
        ProgramId programId = (ProgramId) entityId;
        setAccessResource(programId.getParent(), rangerAccessResource);
        rangerAccessResource.setValue(RangerCommons.KEY_PROGRAM, programId.getType() +
          RangerCommons.RESOURCE_SEPARATOR + programId.getProgram());
        break;
      case SECUREKEY:
        SecureKeyId secureKeyId = (SecureKeyId) entityId;
        setAccessResource(secureKeyId.getParent(), rangerAccessResource);
        rangerAccessResource.setValue(RangerCommons.KEY_SECUREKEY, secureKeyId.getName());
        break;
      default:
