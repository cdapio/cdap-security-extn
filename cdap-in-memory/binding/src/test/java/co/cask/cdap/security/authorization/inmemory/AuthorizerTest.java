 ...
 * the License.
 */
package co.cask.cdap.security.authorization.inmemory;
...
/**
 * Tests for {@link co.cask.cdap.security.spi.authorization.Authorizer}.
 */
public abstract class AuthorizerTest {
  ...
  protected abstract co.cask.cdap.security.spi.authorization.Authorizer get();

  @Test
  public void testSimple() throws Exception {
    co.cask.cdap.security.spi.authorization.Authorizer authorizer = get();
