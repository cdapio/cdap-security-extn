...
/**
 * Class to create {@link Authorizable} from Authorizable type and name
 */
public class ModelAuthorizables {
   ...
   * to be crearted
   * @return the created {@link Authorizable}
   */
  ...
  /**
   * Gets a {@link Authorizable} of the given type and name
   *
   * @param type the {@link AuthorizableType} of the {@link Authorizable} to be created
   * @param name the name of the {@link Authorizable} to be created
   * @return {@link Authorizable} of the given type and name
   */
  public static Authorizable from(AuthorizableType type, String name) {
    switch (type) {
      case INSTANCE:
