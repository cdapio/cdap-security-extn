...
public class AuthBinding {
  ...
  public AuthBinding(String sentrySite, String instanceName, String requestorName) throws Exception {
    this.authConf = loadAuthzConf(sentrySite);
  ...
  private TSentryPrivilege toTSentryPrivilege(Action action, EntityId entityId) {
    final List<Authorizable> authorizables = EntityToAuthMapper.convertEntityToAuthorizable(instanceName, entityId);
